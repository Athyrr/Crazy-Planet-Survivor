// Vertex Animation Texture Data
        // Generated from: Unreal Take
        // Texture: VAT_Unreal Take_Spider_SK.png
        // Frame Count: 30
        // Vertex Count: 1357

        using UnityEngine;

        public class VAT_Unreal_Take_Spider_SK: MonoBehaviour
        {
            // Texture bounds data (ugly hack but flemme de regarder comment faire autrement)
            public static readonly Vector3 MinBounds = new Vector3(-0.09830251f, -0.4684452f, -1.524504f);
            public static readonly Vector3 MaxBounds = new Vector3(0.1047892f, 1.21989f, 0.8282619f);
            public static readonly Vector3 BoundsSize = MaxBounds - MinBounds;
            
            // Animation data
            public static readonly float Duration = 1f;
            public static readonly float FrameRate = 30f;
            public static readonly int TotalFrames = 30;

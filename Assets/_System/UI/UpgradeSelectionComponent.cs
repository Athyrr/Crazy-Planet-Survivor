...
public class UpgradeSelectionComponent : MonoBehaviour
{
    ...
    EntityQuery _upgradeDatabaseQuery;
    ...
    public void DisplaySelection(DynamicBuffer<UpgradeSelectionBufferElement> selection)
    {
        ...
        for (int i = 0; i < selection.Length; i++)
        {
            ...
            var upgradeUIComp = upgradeUIGameObject.GetComponent<UpgradeUIComponent>();
